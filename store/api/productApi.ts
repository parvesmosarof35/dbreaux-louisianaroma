...
export const productApi = baseApi.injectEndpoints({
  endpoints: (builder) => ({
    ...
    getProducts: builder.query<any, any>({
      query: (params = {}) => {
        const { category = "", searchTerm = "", isfeatured, page = 1, limit = 9 } = params;
    ...
    // POST /api/v1/products/create_product (FormData)
    ...
    // PATCH /api/v1/products/update_product/:id (FormData)
