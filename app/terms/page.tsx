...
export const metadata = {
  title: "Terms of Service | Louisianaroma",
  description: "Review the terms and conditions governing the artisanal world of Louisianaroma.",
};
    ...
    <div className="bg-[#121414] min-h-screen text-white flex flex-col">
      ...
      <main className="flex-1 max-w-4xl mx-auto px-6 pt-48 pb-32 w-full space-y-24">
        ...
        <footer className="pt-24 border-t border-white/5 text-center space-y-8">
           <p className="text-white/20 text-sm font-light italic italic leading-relaxed max-w-lg mx-auto">
