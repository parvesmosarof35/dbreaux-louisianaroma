...
import { useGetTermsAndConditionsQuery } from "@/store/api/settingApi";
...
export default function TermsPage() {
  ...
  const termsConditions = termsResponse?.data?.TermsConditions || termsResponse?.data?.termsConditions || "";
