  ...
  return (
    <div className="space-y-12">
      <header className="space-y-4">
         ...
         <h1 className="text-white text-5xl font-serif">Security</h1>
      ...
      <div className="space-y-10 max-w-2xl">
        ...
        <div className="pt-8 border-t border-white/5 flex justify-between items-center">
           ...
           <button className="bg-[#F2CA50] text-black text-[10px] font-bold tracking-[3px] uppercase px-12 py-6 rounded-2xl hover:bg-white transition-all duration-500 shadow-[0_20px_40px_rgba(242,202,80,0.2)]">Update Password</button>
        </div>
      </div>
    </div>
  );
