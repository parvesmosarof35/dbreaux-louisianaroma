        ...
        <section className="space-y-8 md:space-y-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10">
            <div className="space-y-3">
              ...
              <input type="text" defaultValue="New York" className="w-full bg-white/5 border border-white/10 px-6 md:px-8 py-4 md:py-5 rounded-2xl text-white outline-none focus:border-[#F2CA50]/50 transition-all font-light" />
            </div>
            <div className="space-y-3">
              <label className="text-white/20 text-[9px] font-bold tracking-[2px] uppercase">Postal Code</label>
              <input type="text" defaultValue="10021" className="w-full bg-white/5 border border-white/10 px-6 md:px-8 py-4 md:py-5 rounded-2xl text-white outline-none focus:border-[#F2CA50]/50 transition-all font-light" />
            </div>
          </div>
        </section>

        <div className="pt-8 border-t border-white/5 flex justify-end">
           <button className="w-full md:w-auto bg-[#F2CA50] text-black text-[10px] font-bold tracking-[3px] uppercase px-12 py-6 rounded-2xl hover:bg-white transition-all duration-500 shadow-[0_20px_40px_rgba(242,202,80,0.2)]">Save Changes</button>
        </div>
      </div>
    </div>
  );
