  ...
  return (
    <div className="space-y-12">
      <header className="space-y-4">
         ...
         <h1 className="text-white text-5xl font-serif">My Orders</h1>
      ...
      <div className="space-y-6">
        {MY_ORDERS.map((order) => (
          <div key={order.id} className="bg-white/5 border border-white/10 rounded-[32px] p-8 flex items-center gap-10 group hover:border-[#F2CA50]/30 transition-all duration-500">
            <div className="relative w-32 aspect-square bg-black/40 rounded-2xl overflow-hidden shrink-0 border border-white/5">
            ...
            <div className="flex-1 flex flex-col md:flex-row justify-between gap-8 py-2">
              <div className="space-y-3">
                ...
                <h3 className="text-white text-3xl font-serif">{order.name}</h3>
              ...
              <div className="flex flex-col items-end justify-between py-2">
                <div className="text-white text-2xl font-light">${order.price.toFixed(2)}</div>
